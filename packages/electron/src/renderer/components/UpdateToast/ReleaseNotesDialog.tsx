    ...
    >
      ...
      >
        ...
        <div className="update-dialog-header mb-4 pr-8">
          <h2 className="update-dialog-title text-lg font-semibold text-[var(--nim-text)] m-0">Nimbalyst 有新版本可用!</h2>
        </div>

        {/* Version comparison */}
        <div className="update-dialog-version-row flex items-center gap-2 mb-5 flex-wrap">
          <span className="update-dialog-version-label text-xs text-[var(--nim-text-muted)]">当前版本:</span>
          ...
          <span className="update-dialog-version-label text-xs text-[var(--nim-text-muted)]">最新版本:</span>
        ...
        <div className="update-dialog-content flex-1 overflow-y-auto mb-5 pr-2">
          <h3 className="update-dialog-notes-title text-sm font-semibold text-[var(--nim-text)] m-0 mb-3">{newVersion} - 版本说明</h3>
          <div
