---
name: "source-command-promote-public-release"
description: "Build, refine, and publish cumulative public release notes, then promote the current alpha prerelease to stable"
---

# source-command-promote-public-release

Use this skill when the user asks to run the migrated source command `promote-public-release`.
