---
name: "source-command-e2e-devcontainer"
description: "Run E2E tests in a dev container (isolated environment)"
---

# source-command-e2e-devcontainer

Use this skill when the user asks to run the migrated source command `e2e-devcontainer`.
...
- Multiple files: `e2e/core/app-startup.spec.ts e2e/ai/Codex-basic.spec.ts`
