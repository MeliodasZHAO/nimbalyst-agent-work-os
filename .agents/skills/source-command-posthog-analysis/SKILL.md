---
name: "source-command-posthog-analysis"
description: "Analyze PostHog usage data with correct filters, timelines, and caveats."
---

# source-command-posthog-analysis

Use this skill when the user asks to run the migrated source command `posthog-analysis`.
