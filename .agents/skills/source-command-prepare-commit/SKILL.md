---
name: "source-command-prepare-commit"
description: "Comment out inappropriate logging before commit"
---

# source-command-prepare-commit

Use this skill when the user asks to run the migrated source command `prepare-commit`.
